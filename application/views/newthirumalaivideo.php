	...
	<div class="container">
		...
		<div class="card mycard shadow">
			<div class="card-header">
				<h4>New Dhinam Oru Nalvarthai Thirumalai Patri -Video</h4>
			</div>
			<div class="card-body">
		...
		if (filename == "" || file == "") {
			...
			$.ajax({
				...
				success:function(data) {
					...
					nalvarthaiLog("Thirumalai Patri",folder + "/" + filename,"video",data,"new");
				},
				error:function() {
					_("warning").style.display = "block";
					nalvarthaiLog("Thirumalai Patri",folder + "/" + filename,"video","Error","new");
				}
			});
		}
