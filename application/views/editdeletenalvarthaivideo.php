			...
			<table class="table table-hover text-center shadow">
				...
				<tbody  id="table">
                    ...
                    if (!$connection) {
                        ...
                        $data = '';
                        $select_query = "SELECT * FROM dailyvideo";
...
<script>
	...
	function deleteAudio() {
		...
		if (url == "") {
			...
			$.ajax({
				url:"<?php echo base_url(); ?>index.php/home/deleteNalvarthaiVideo",
				method:"POST",
				data:{url:url},
				success:function(data) {
					...
					nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"video",data,"Delete");
				},
				error:function() {
					_("dwarning").style.display = "block";
					nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"video","Error","Delete");
				}
			});
		}
	...
	function editVideo() {
		...
		if (folderName == "" || filename == "") {
			...
			if (file == "") {
				$.ajax({
					url:"<?php echo base_url(); ?>index.php/home/editNalvarthaiVideoWithoutFile",
					method:"POST",
					...
					success:function(data) {
						...
						nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"video",data,"Edit filename");
					},
					error:function() {
						_("warning").style.display = "block";
						nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"video","Error","Edit filename");
					}
				});
			} else {
				//code for file
				...
				$.ajax({
					...
					url:"<?php echo base_url(); ?>index.php/home/editNalvarthaiVideoWithFile",
					method:"POST",
					data:formdata,
					contentType:false,
					cache:false,
					...
					success:function(data) {
						...
						nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"video",data,"Edit file");
					},
					error:function() {
						_("warning").style.display = "block";
