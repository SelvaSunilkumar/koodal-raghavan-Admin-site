...
<div class="container">
    ...
    <div class="card shadow">
        <div class="card-header shadow">
            <h4>New 108'il Alwargalin Manam Audio</h4>
        </div>
        <div class="card-body text-center">
            ...
            <div class="form-group">
                <input type="file" id="file" accept=".mp3,.pdf" class="form-control">
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col">
...
<script>
    ...
    $(document).ready(function() {
        $("#folder").keyup(function() {
            ...
            if (searchText != '') {
                $.ajax({
                    url:"<?php echo base_url(); ?>index.php/home/searchAlwarAudio",
                    method:"POST",
    ...
    function upload() {
        ...
        if (foldername == "" || filename == "" || file == "" || price == "" || type == "") {
            ...
            $.ajax({
                ...
                url:"<?php echo base_url(); ?>index.php/home/uploadnewalwaraudiofile",
                method:"POST",
                data:formdata,
                contentType:false,
                cache:false,
    ...
    function loader() {
        ...
        if (checked) {
            if (_("folder").value == "") {
                ...
                $.ajax({
                    url:"<?php echo base_url(); ?>index.php/home/getAlwarAudioDetails",
                    method:"POST",
