			...
			<div class="container">
                ...
                <div class="card mycar" style="width: 100%; display: block;" id="details">
		    		...
		    		<div class="card-body bo">
		    			<input type="text" id="foldername" class="form-control" placeholder="Folder Name" readonly>
		    			<br>
		    			<div class="input-group mb-3">
		    			...
		    			<br>
		    			<progress id="progress" value="50" max="100" style="width: 100%;">
		    				<p id="status">0%</p>
		    			</progress>
		    		</div>
		    		<div class="card-footer text-center" id="editStatus">
                        <button type="button" class="btn btn-success" onclick="editAudio()">Edit Now</button>&emsp;&emsp;
			...
			<table class="table table-hover text-center shadow">
				...
				<tbody  id="table">
                    ...
                    if (!$connection) {
                        ...
                        $data = '';
                        $select_query = "SELECT * FROM dailyaudio ORDER BY `dailyaudio`.`folder` ASC";
...
<script>
	...
	function deleteAudio() {
		...
		if (url == "") {
			...
			$.ajax({
				url:"<?php echo base_url(); ?>index.php/home/deleteNalvarthaiAudio",
				method:"POST",
				data:{url:url},
				success:function(data) {
					...
					nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"audio",data,"Delete");
				},
				error:function() {
					_("dwarning").style.display = "block";
					nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"audio","Error","Delete");
				}
			});
		}
	...
	function editAudio() {
		...
		if (folderName == "" || filename == "") {
			...
			if (file == "") {
				$.ajax({
					url:"<?php echo base_url(); ?>index.php/home/editNalvarthaiAudioWithoutFile",
					method:"POST",
					...
					success:function(data) {
						...
						nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"audio",data,"Edit filename");
					},
					error:function() {
						_("warning").style.display = "block";
						nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"audio","Error","Edit filename");
					}
				});
			} else {
				//code for file
				...
				$.ajax({
					...
					url:"<?php echo base_url(); ?>index.php/home/editNalvarthaiAudioWithFile",
					method:"POST",
					data:formdata,
					contentType:false,
					cache:false,
					...
					success:function(data) {
						...
						nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"audio",data,"Edit file");
					},
					error:function() {
						_("warning").style.display = "block";
						nalvarthaiLog("Dhinam Oru Nalvarthai",folderName + "/" + fileName,"video","Error","Edit file");
					}
				});
			}
		}
