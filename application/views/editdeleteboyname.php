			...
			<table class="table table-hover text-center shadow">
				...
				<tbody  id="table">
                    ...
                    if (!$connection) {
                        ...
                        $data = '';
                        $select_sambavanai_query = "SELECT * FROM boyname";
	...
	<script>
		...
		function editName() {
			...
			if (newName == "" || existName == "") {
				...
				$.ajax({
					url:"<?php echo base_url(); ?>index.php/home/editBoyName",
					method:"POST",
					...
					success:function(data) {
						...
						babyname(existName + " : " + newName,"boy","edit",data);
					},
					error:function() {
						_("warning").style.display = "block";
						babyname(existName + " : " + newName,"boy","edit","Error");
					}
				});
			}
		...
		function deleteName() {
			...
			if (name == "") {
				...
				$.ajax({
					url:"<?php echo base_url(); ?>index.php/home/deleteBoyName",
					method:"POST",
					data:{name:name},
					success:function(data) {
						if (data == "ok") {
						...
						babyname(name,"boy","delete",data);
					},
					error:function() {
						alert(response);
						_("dwarning").style.display = "block";
						babyname(name,"boy","delete","Error");
					}
				});
			}
